  ...
  return (
    <div className='horizontal-menu'>
        <ul>
            ...
            <li className='manu-4'><NavLink to="./addPlacUse"><span>แจ้งใช้สิ่ง/เลิกใช้สิ่งของ</span></NavLink></li>
            <li className='manu-5'><NavLink to="./ceratrWatData"><span>จัดการข้อมูลวัด</span></NavLink></li>
        </ul>
    </div>
  )
}
