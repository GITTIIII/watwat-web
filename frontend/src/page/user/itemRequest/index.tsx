      ...
      <form onSubmit={handleSubmit}>
        <div className="content">
          ...
          <div className="text-long">
            *หากบันทึกรายการยืมแล้ว ระบบแจ้งว่า “ยังไม่อนุมัติ” เป็นตัวหนังสือ
            <b id="fontred1">สีแดง</b>ให้อ่านรายละเอียดที่
            <b id="fontred2">หมายเหตุ</b> เพื่อตรวจสอบและแก้ไขข้อมูล
            ถ้าขึ้นเป็นตัวหนังสือ<b id="fontblack">สีดำ</b>ให้รอการอนุมัติจาก
            Creator
          </div>
